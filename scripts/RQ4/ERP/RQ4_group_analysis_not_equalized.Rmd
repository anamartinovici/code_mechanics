---
title: "RQ4 - ERP results NOT equalized"
...
```{python}
exec(open("RQ4_group_analysis_not_equalized.py", encoding="utf-8").read())

f_RQ4_group_analysis_NOTeq(project_seed = r.project_seed, 
