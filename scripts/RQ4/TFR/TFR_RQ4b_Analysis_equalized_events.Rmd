---
title: "RQ4b - Analysis equalized events"
...
```{python}
exec(open("TFR_RQ4b_Analysis_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ4b_analysis_eq(project_seed = r.project_seed,  
