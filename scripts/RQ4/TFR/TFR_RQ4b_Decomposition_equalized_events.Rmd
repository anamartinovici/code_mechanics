---
title: "RQ4b - Decomposition equalized events"
...
```{python}
exec(open("TFR_RQ4b_Decomposition_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ4b_decomp_eq(project_seed = r.project_seed,  
