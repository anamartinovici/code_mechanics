...
path_to_TFR_step2_output <- paste0(DIR_local_files, "/data_outside_repo/processed_data/TFR/step2/")
...
```{python}
exec(open("TFR_RQ2.py", encoding="utf-8").read())

f_TFR_RQ2(project_seed = r.project_seed, 
          path_to_eeg_BIDS = r.path_to_eeg_BIDS,
          path_to_TFR_step1_output = r.path_to_TFR_step1_output, 
          path_to_TFR_step2_output = r.path_to_TFR_step2_output,
