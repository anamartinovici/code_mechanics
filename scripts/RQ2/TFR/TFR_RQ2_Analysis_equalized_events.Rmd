---
title: "RQ2 - Analysis equalized events"
...
```{python}
exec(open("TFR_RQ2_Analysis_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ2_analysis_eq(project_seed = r.project_seed, 
