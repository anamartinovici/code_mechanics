def f_TFR_RQ2_decomp_NOTeq(project_seed, path_to_eeg_BIDS, path_to_TFR_step1_output, path_to_TFR_RQ2_output):
    import mne
    import random
    ...
    np.save(opj(path_to_TFR_RQ2_output, "not_equalized", "power_all_subj_new"), power_all_subj_new)
    np.save(opj(path_to_TFR_RQ2_output, "not_equalized", "power_all_subj_old"), power_all_subj_old)
