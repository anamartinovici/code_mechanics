---
title: "RQ2 - Decomposition equalized events"
...
```{python}
exec(open("TFR_RQ2_Decomposition_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ2_decomp_eq(project_seed = r.project_seed, 
