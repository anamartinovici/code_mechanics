---
title: "RQ2 - Decomposition NOT equalized events"
...
```{python}
exec(open("TFR_RQ2_Decomposition_not_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ2_decomp_NOTeq(project_seed = r.project_seed, 
