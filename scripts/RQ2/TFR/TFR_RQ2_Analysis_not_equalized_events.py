def f_TFR_RQ2_analysis_NOTeq(project_seed, path_to_TFR_step1_output, path_to_TFR_RQ2_output, path_to_cache_dir):
    import mne
    import random
    import time
    ...
    power_all_subj_old = np.load(opj(path_to_TFR_RQ2_output, "not_equalized", "power_all_subj_old.npy"))
    power_all_subj_new = np.load(opj(path_to_TFR_RQ2_output, "not_equalized", "power_all_subj_new.npy"))
