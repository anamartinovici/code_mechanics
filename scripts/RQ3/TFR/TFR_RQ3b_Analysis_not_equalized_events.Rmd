---
title: "RQ3b - Analysis NOT equalized events"
...
```{python}
exec(open("TFR_RQ3b_Analysis_not_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ3b_analysis_NOTeq(project_seed = r.project_seed,  
