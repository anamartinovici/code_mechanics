---
title: "RQ3b - Decomposition NOT equalized events"
...
```{python}
exec(open("TFR_RQ3b_Decomposition_not_equalized_events.py", encoding="utf-8").read())

f_TFR_RQ3b_decomp_NOTeq(project_seed = r.project_seed,  
