def f_ERP_preproc_step1(project_seed, path_to_eeg_BIDS, path_to_ERP_step1_output, events_path):
    #!/usr/bin/env python3
    # -*- coding: utf-8 -*-
    '''
    ...
    '''
    # path_to_eeg_BIDS = directory with eeg_BIDS data received from the EEG_manypipelines team
    # path_to_ERP_step1_output = directory where this script saves preprocessed files
    # events_path = './data_in_repo/original_data/events/' # directory where this script saves event files
